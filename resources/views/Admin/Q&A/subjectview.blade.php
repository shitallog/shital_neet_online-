...
<div class="d-flex justify-content-between mb-3">
                    <h4 class="text-center">Answer Details</h4>
    ...
    <table id="dataTable" class="text-center">
        ...
        <tbody>
                ...
                <tr>
                 ...
                 <td><p><strong>correct_answer:</strong>{{ $quiz->subject->name }}</p></td>
                 
                 <!--   <td></td>-->
                    <td>
                            <!-- Actions like view, edit, delete can go here -->
                            <a href="{{ route('quizzes.edit', $question->id) }}" class="btn btn-info btn-sm">Edit</a>
