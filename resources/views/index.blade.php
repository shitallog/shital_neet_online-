            ...
            <div class="row course-gallery ">
                ...
                <div class="course-item cat1 cat3 col-lg-6 col-md-6">
                    <div class="course-block">
                        ...
                        @if ($package->image)
                         <img src="{{ asset('image/' . $package->image) }}" class="img-fluid" alt="{{ $package->package_name }}" width="900px">
                            @else
                                No Image
                            @endif
                        ...
                        <div class="course-content">
                            ...
                            <p>Valid upto May,{{ $package->year }}</p>
                            ...
                            <br>
                               <div class="buy-btn">
                                    <a href="{{ route('login') }}" class="btn btn-main-2 btn-small">Buy Now</a>
                               </div>
