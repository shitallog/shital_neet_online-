        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6">
                <div class="section-heading center-heading">
                    <!-- <H1 class="align-items-center">Contact Us</H1>
                    -->
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="col-lg-12 col-md-6">
                        <div class="contact-item">
                            <p>About</p>
                            <h4>    Monarch Institute offers comprehensive coaching services for medical entrance examinations, NEET. </h4>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="contact-item">
                            <p>Email Us</p>
                            <h4>info@monarchinstitute.in</h4>
                        </div>
                    </div>
                     <div class="col-lg-12 col-md-6">
                        <div class="contact-item">
...
<form method="POST" action="{{ route('contact.store') }}">
            ...
            <br>
            <button class="btn btn-lg btn-secondary"  type="submit"> <i class="fa fa-angle-right ml-2"></i> Send Message</button>
</form>
