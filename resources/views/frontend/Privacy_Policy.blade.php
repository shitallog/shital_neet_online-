...
<div class="container">
    ...
    <p>At Monarchinstitute.in, we are committed to protecting your privacy. This policy outlines how we collect, use, and protect your personal information when you use our services.</p>

    <h2>2. Information We Collect</h2>
    <p>We may collect the following types of information:</p>
    <ul>
      <li><strong>Personal Information:</strong> Name, email address, phone number, and payment information.</li>
      <li><strong>Usage Data:</strong> Information on how you use our website and services, including IP addresses and browser types.</li>
      <li><strong>Cookies:</strong> We may use cookies to enhance user experience and analyze website traffic.</li>
    </ul>
    ...
    <ul>
      ...
      <li>Communicating with you regarding your account and services</li>
    ...
    <p>We may update this privacy policy from time to time. Changes will be posted on our website with an updated effective date.</p>
