...
<div class="container">
    ...
    <p>By accessing and using the services provided by Monarchinstitute.in you agree to comply with these Terms and Conditions. If you do not agree, please refrain from using our services.</p>

    <h2>2. Services Provided</h2>
    <p>Monarch Institute offers online courses and educational resources. Details regarding course offerings, schedules, and pricing can be found on our website.</p>

    <h2>3. Registration and Account Security</h2>
    <ul>
      <li>Users must create an account to access certain services.</li>
    ...
    <ul>
      <li>All fees must be paid in full before accessing course materials.</li>
      <li>Refund policies are outlined separately and can be found on our website.</li>
    </ul>

    <h2>5. Intellectual Property</h2>
    <p>All content provided by Monarchinstitute.in, including course materials, videos, and assessments, is protected by copyright. Users may not reproduce, distribute, or modify this content without prior written consent.</p>

    <h2>6. User Conduct</h2>
    <ul>
      <li>Users agree to engage in respectful and constructive behavior.</li>
      <li>Harassment, discrimination, or any form of misconduct will not be tolerated and may result in account termination.</li>
    </ul>

    <h2>7. Limitation of Liability</h2>
    <p>Monarchinstitute.in is not liable for any indirect, incidental, or consequential damages resulting from the use of our services.</p>

    <h2>8. Modifications to Terms</h2>
    <p>We reserve the right to update these Terms and Conditions at any time. Users will be notified of significant changes via email or through our website.</p>

    <h2>9. Contact Information</h2>
    <p>If you have any questions regarding these Terms and Conditions, please contact us:</p>
    <div class="contact-info">
      <p>Email: <a href="mailto:info@monarchinstitute.in">info@monarchinstitute.in</a></p>
      <p>Phone Number: 9136431685</p>
    </div>
  </div>
