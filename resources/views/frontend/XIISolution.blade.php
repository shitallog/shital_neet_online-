...
<!-- <div class="course-single-thumb">
      ...
      <div class="course-price-wrapper">
          ...
          <!-- <div class="buy-btn"><a href="#" class="btn btn-main btn-block">Download Schedule & syllabus</a></div>
      </div>
  </div>  -->
</div>
<div class="course-widget course-info">
        <!-- <h4 class="course-title">Target NEET 2025 (Monarch Success Sprint test Series NEET 2025)</h4> -->
       
        <embed src="{{ asset('frontend/assets/pdf/Monarch class 12th key.pdf') }}" type="application/pdf">
                <!-- <iframe src="{{ asset('frontend/assets/images/pdf/Monarch Elite Test Series NEET-2025.pdf') }}"></iframe> -->

   
            <!-- <li>
                <i class="fa fa-check"></i>
                <a href="#" class="btn btn-main btn-block">Download Schedule & syllabus</a>
            </li>
            <li>
                <i class="fa fa-check"></i>
                <a href="#" class="btn btn-main btn-block">Download Schedule & syllabus</a>
