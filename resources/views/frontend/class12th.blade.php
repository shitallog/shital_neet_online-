...
<div class="course-single-thumb">
      ...
      @foreach($uploads as $upload)
          ...
          <a href="{{ route('view', ['id' => $upload->id]) }}" class="btn btn-sm btn-primary" target="_blank">
                    <i class="fas fa-eye"></i> CLASS XII PDF VIEW
  </a>

  <!-- <p>File URL: {{ asset('storage/' . $upload->file_path) }}</p> -->
<!-- <iframe src="{{ asset('storage/' . $upload->file_path) }}" allowfullscreen style="width: 100%; height: 500px; border: none;"></iframe> -->
  @endforeach
