...
<div class="course-single-thumb">
      ...
      <div class="course-price-wrapper">
          ...
          <!-- <div class="course-price ml-3"><h4>Test Schedule & Syllabus</h4></div> -->
          <a  id="pdfViewer" href="{{ route('viewpdf', ['id' => $class12->id]) }}" class="btn btn-sm btn-primary" target="_blank">
    <i class="fas fa-eye"></i> CLASS XII PASSED VIEW
</a>
...
<!-- 
  <iframe 
    id="pdfViewer"
    src="{{ route('viewPdf', ['id' => $class12->id]) }}#toolbar=0" 
    width="100%" 
    height="600px" 
    style="border:none;">
</iframe> -->
