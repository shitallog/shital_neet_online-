        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    @endif
                    <li>
                        <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-tasks"></i><span>uplode Schedule </span></a>
                        <ul class="collapse">
                            <li class="{{ Route::is('Admin.Quiz.create') ? 'active' : '' }}"><a href="{{ route('Admin.Quiz.create') }}">uplode Schedule</a></li>
                    ...
                    <li>
                        <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-tasks"></i><span>Quiz </span></a>
                        <ul class="collapse">
                    ...
                    <li>
                        <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-tasks"></i><span>User</span></a>
                        <ul class="collapse">
                            <li class="{{ Route::is('Admin.User.index') ? 'active' : '' }}"><a href="{{ route('Admin.User.index') }}">User</a></li>
                        </ul>
